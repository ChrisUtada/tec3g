...
func _ready():
	...
	CardManager.spawn_card(plant_hunter, Vector2(790, 80))
	CardManager.spawn_card(tec, Vector2(1020, 80))
	CardManager.spawn_card(junior, Vector2(100, 350))
	CardManager.spawn_card(coin, Vector2(330, 350))
	CardManager.spawn_card(peek, Vector2(560, 350))
	CardManager.spawn_card(zhusui, Vector2(790, 350))
